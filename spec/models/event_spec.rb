...
RSpec.describe Event, type: :model do
  ...
  describe "instance methods" do
    before :each do
      ...
      PlayerEvent.create!(player_id: @player_3.id, event_id: @event_1.id , invite_accepted: nil)

      PlayerEvent.create!(player_id: @player_1.id, event_id: @event_2.id , invite_accepted: nil)
      PlayerEvent.create!(player_id: @player_3.id, event_id: @event_2.id , invite_accepted: false)
      PlayerEvent.create!(player_id: @player_4.id, event_id: @event_2.id , invite_accepted: true)
    end
