...
RSpec.describe "Get Single Player's Events Endpoint" do
  describe "happy path" do
    it 'returns the events for a single player' do
      ...
      player_4 = Player.create!(id: 4, name: 'player 4', phone: "999.999.1237", email: "test4@test.com")
      player_5 = Player.create!(id: 5, name: 'player 5', phone: "999.999.1238" , email: "test5@test.com")
      player_6 = Player.create!(id: 6, name: "player 6", phone: "999.999.1239" , email: "test6@test.com")
