...
Friendship.create!(follower_id: 1, followee_id: 6)
Friendship.create!(follower_id: 2, followee_id: 1)
Friendship.create!(follower_id: 2, followee_id: 3)
Friendship.create!(follower_id: 2, followee_id: 4)
Friendship.create!(follower_id: 2, followee_id: 5)
...
Friendship.create!(follower_id: 3, followee_id: 4)
Friendship.create!(follower_id: 3, followee_id: 5)
Friendship.create!(follower_id: 3, followee_id: 6)
Friendship.create!(follower_id: 4, followee_id: 1)
Friendship.create!(follower_id: 4, followee_id: 2)
Friendship.create!(follower_id: 4, followee_id: 3)
Friendship.create!(follower_id: 4, followee_id: 5)
Friendship.create!(follower_id: 4, followee_id: 6)
Friendship.create!(follower_id: 5, followee_id: 1)
Friendship.create!(follower_id: 5, followee_id: 2)
Friendship.create!(follower_id: 5, followee_id: 3)
Friendship.create!(follower_id: 5, followee_id: 4)
Friendship.create!(follower_id: 5, followee_id: 6)
Friendship.create!(follower_id: 6, followee_id: 1)
Friendship.create!(follower_id: 6, followee_id: 2)
Friendship.create!(follower_id: 6, followee_id: 3)
Friendship.create!(follower_id: 6, followee_id: 4)
Friendship.create!(follower_id: 6, followee_id: 5)
...
PlayerEvent.create!(player_id: 4, event_id: 1, invite_accepted: true)
...
#event 3 closes with 1 spot accepted
